        ...
        <div class="top-operation-area">
          <div class="top-button-left">
            ...
            >
              <el-button
                type="text"
                @click="play"
                class="operation-area-btn el-icon-video-play"
              ></el-button>
            </el-tooltip>
            <el-tooltip
              v-else
            ...
            >
              <el-button
                type="text"
                @click="pause"
                class="operation-area-btn el-icon-video-pause"
              ></el-button>
            </el-tooltip>
          ...
          <div class="top-button-right">
            <div class="search-entity-bar">
              ...
              >
                <el-button
                  ...
                  class="operation-area-btn el-icon-search"
                ></el-button>
              </el-tooltip>
              <el-autocomplete
            ...
            >
              <el-button
                type="text"
                class="operation-area-btn iconfont icon-keyframes"
                @click="addKeyframe"
              ></el-button>
            </el-tooltip>
            <el-tooltip
            ...
            >
              <el-button
                ...
                type="text"
                class="operation-area-btn iconfont icon-delete"
                @click="deleteEntity(activateEntity)"
              ></el-button>
            </el-tooltip>
            <el-tooltip
              class="item"
            ...
            >
              <el-button
                type="text"
                class="operation-area-btn iconfont icon-suoxiao"
                @click="changeScale(-10)"
              ></el-button>
            </el-tooltip>
            <el-slider
              v-model="trackScale.value"
              class="operation-area-slider"
              style="width: 100px"
              :step="10"
              :max="trackScale.max"
              :min="trackScale.min"
            ...
            >
              <el-button
                type="text"
                class="operation-area-btn iconfont icon-fangda"
                @click="changeScale(10)"
              ></el-button>
            </el-tooltip>
          </div>
...
export default {
  ...
  computed: {
    ...
    playCursorX() {
      ...
      return (
        getGridPixel(this.trackScale.value, times) -
        this.startX -
        this.offsetLine.left
      );
    },
  ...
  methods: {
    ...
    /** 添加关键帧 */
    addKeyframe() {
      this.$cesiumHelper.camera
        .addCamera({ availability: this.currentTime })
        .then((entity) => {
    ...
    searchEntity(val) {
      ...
      this.$refs.tracksRef.activatedTrack(
        this.$cesiumHelper.getEntityInfo(val.id)
      );
      this.searchName = "";
    },
    ...
    timeDrop(x) {
      x =
        x + this.startX + this.offsetLine.left > 0
          ? x + this.startX + this.offsetLine.left
          : 0;
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      this.$cesiumHelper.player.addEventListener(
        "change",
        "timeChange",
