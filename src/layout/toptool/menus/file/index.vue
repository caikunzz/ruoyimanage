<template>
  <el-dropdown trigger="click" @command="handleCommand" placement="top-start">
    <div class="el-dropdown-link tool-menu-item">文件</div>
    <el-dropdown-menu slot="dropdown">
      <el-dropdown-item command="import"
        ><i class="iconfont icon-dakaiwenjianjia"></i>打开文件</el-dropdown-item
      >
      <el-dropdown-item command="export"
        ><i class="iconfont icon-quanbubaocungongzuobiao"></i
        >另存为文件</el-dropdown-item
      >
      <el-dropdown-item command="saveImg"
        ><i class="iconfont icon-chucunweitupian"></i>快速出图</el-dropdown-item
      >
      <el-dropdown-item command="clean"
        ><i class="iconfont icon-qingchu"></i>清除缓存</el-dropdown-item
      >
    </el-dropdown-menu>
  </el-dropdown>
</template>
