        ...
        <el-collapse v-model="activeNames" @change="handleChange">
          <el-collapse-item title="视频" name="1">
            <el-form-item label="名称：">
              <el-input size="mini" v-model="form.name" placeholder="请输入标题"></el-input>
            </el-form-item>
            ...
            <el-form-item label="帧率：" clearable size="mini">
              <el-select v-model="form.video.frameRateValue" placeholder="请选择">
                <el-option
            ...
            <el-form-item label="分辨率：" clearable size="mini">
              <el-select v-model="form.video.resolutionValue" placeholder="请选择">
                <el-option
          ...
          <el-collapse-item title="音频" name="2">
            ...
            <el-form-item label="采样率：" clearable size="mini">
              <el-select v-model="form.audio.samplingRateValue" placeholder="请选择">
                <el-option
...
export default {
  ...
  methods: {
    ...
    submitDialog() {
      const loadingInstance = Loading.service({ fullscreen: true, text: "正在导出视频...", background: "rgba(0,0,0,.6)" });
