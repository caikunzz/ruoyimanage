    ...
    <el-tabs v-model="activeName" type="border-card">
      <el-tab-pane label="象形图形" name="first">
        <el-collapse accordion>
          <el-collapse-item v-for="(item, index) in pictographic" :key="index" :title="item.name">
      ...
      <el-tab-pane label="军队图形" name="second">
        <el-collapse accordion>
          <el-collapse-item v-for="(item, index) in militaryGraphic" :key="index" :title="item.name">
      ...
      <el-tab-pane label="其它图形" name="third">
        <el-collapse accordion>
          <el-collapse-item v-for="(item, index) in otherGraphic" :key="index" :title="item.name">
        ...
        <el-collapse accordion>
          <el-collapse-item title="导入文件" v-loading="customGraphicLoading">
            <div class="input-wrapper">
              ...
              <el-button size="mini" type="primary" @click="getCustomImgList(1)" icon="el-icon-search">搜索</el-button>
              <el-upload
                  size="mini"
                  class="upload-demo"
  ...
  methods: {
        ...
        militaryGraphic: [
          {
            name: "我军",
            value: [
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/navy.png"), name: '海军'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/air_force.png"), name: '空军'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/Rocket_Army.png"), name: '火箭军'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/artillery.png"), name: '炮兵部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/armor.png"), name: '装甲部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/anti-aircraft_fighter.png"), name: '防空部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/engineering.png"), name: '工程部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/chemistry.png"), name: '防化学部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/communication.png"), name: '通信部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/cavalry.png"), name: '骑兵部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/militia.png"), name: '民兵部队'},
              {url: require("@/assets/images/iconPlotImgs/ourMilitary/airborne.png"), name: '空降兵部队'},
            ]
          }, {
            name: "北约",
            value: [
              {url: require("@/assets/images/iconPlotImgs/usMilitary/步兵.png"), name: '步兵'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/空军.png"), name: '空军'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/海军.png"), name: '海军'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/装甲部队.png"), name: '装甲部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/榴弹炮部队.png"), name: '火箭军'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/陆基防空.png"), name: '陆基防空'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/保养部队.png"), name: '保养部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/军事情报部队.png"), name: '军事情报'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/军需部队.png"), name: '军需部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/化学兵部队.png"), name: '化学部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/医疗部队.png"), name: '医疗部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/宪兵部队.png"), name: '宪兵部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/工程兵部队.png"), name: '工程部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/心理战部队.png"), name: '心理部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/特种部队.png"), name: '特种部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/运输部队.png"), name: '运输部队'},
              {url: require("@/assets/images/iconPlotImgs/usMilitary/通信部队.png"), name: '通信部队'},
            ]
          }
        ],
        otherGraphic: [
    ...
    getCustomImgList(val){
      ...
      fileNodeApi.list(this.queryParams).then(res=>{
        ...
        this.customGraphic = res.rows.map(item=>{return {id:item.id, name: item.fileName, url: item.fileUrl}})
    ...
    async dragend(event) {
      ...
      this.$cesiumHelper.plotting.imagePlotting.createImagePlot({url: img_path, position: position}).then(entity=>{
