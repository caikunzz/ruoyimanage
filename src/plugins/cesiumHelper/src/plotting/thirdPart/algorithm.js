...
xp.algorithm.getAttackArrowHeadPoints = function (t, o, e, defaultParam) {      //调整攻击箭头头部大小
    this.headHeightFactor = defaultParam.headHeightFactor*1.2;
    this.headTailFactor = defaultParam.headTailFactor;
    this.headWidthFactor = defaultParam.headWidthFactor*1.2;
