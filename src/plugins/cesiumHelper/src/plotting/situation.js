...
class SituationPlotting {
    ...
    copyEntityAdd(entity) {
        return new Promise(resolve => {
            ...
            if (entity.GeoType === "Flag") {
                ...
                plottingJson.availability = dateUtils.parseDateToString("yyyy-MM-ddTHH:mm:ssZ", new Date(plottingJson.startTime)) + "/" + dateUtils.parseDateToString("yyyy-MM-ddTHH:mm:ssZ", plottingJson.endTime)
            }
    ...
    storageEntity(entity) {
        ...
        switch (entity.GeoType) {
            case "AttackArrow":
                this.AttackArrowClass.editAttackArrow(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "LineArrow":
                this.LineArrowClass.editLineArrow(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "CurveArrow":
                this.CurveArrowClass.editCurveArrow(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "SwallowtailArrow":
                this.SwallowtailArrowClass.editSwallowtailArrow(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "PincerArrow":
                this.PincerArrowClass.editPincerArrow(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "AssemblePolygon":
                this.AssembleClass.editAssemble(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "DefenseLine":
                this.DefenseLineClass.editDefenseLine(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "Polygon":
                this.PolygonClass.editPolygon(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "CurvedPolygon":
                this.CurvePolygonClass.editCurvedPolygon(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "Polyline":
                this.PolylineClass.editPolyline(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "Curve":
                this.CurveLineClass.editCurveLine(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "RightAngleArrow":
                this.RightAngleArrowClass.editRightAngleArrow(this.viewer, entity, this._editHandler, this._editCollection)
                break
            case "RoundRectangle":
                this.RoundRectangleClass.editRoundRectangle(this.viewer, entity, this._editHandler, this._editCollection)
                break
            default:
                break;
        }
    ...
    editEvent(currentId) {
        ...
        this._moveHandler.setInputAction(function (movement) {
            ...
            if (Cesium.defined(pick) && pick.id) {
                ...
                if (pickEntity.GeoType && pickEntity.Editable && pickEntity.id === currentId) {
                ...
                if (pickEntity.GeoType && (pickEntity?.GeoType.includes("Edit") || pickEntity?.GeoType.includes("EditPoint"))) {
                    this.viewer.container.style.cursor = "pointer";
                    showToolTip(pickEntity.GeoType, this._toolTip, endPos, true);
                }
            } else {
     ...
     */
    loopDeduplication() {
        const uniqueArray = Array.from(new Map(this.editEntityArr.map(item => [item.id, item])).values());
        this.editEntityArr = []
        ...
        switch (options.geoType) {
            case "AttackArrow":
                return new Promise((resolve, reject) => {
                    this.AttackArrowClass.showAttackArrow(options).then(entity=>{
            ...
            case "LineArrow":
                return new Promise((resolve, reject) => {
                    this.LineArrowClass.showLineArrow(options).then(entity=>{
            ...
            case "CurveArrow":
                return new Promise((resolve, reject) => {
                    this.CurveArrowClass.showCurveArrow(options).then(entity=>{
            ...
            case "SwallowtailArrow":
                return new Promise((resolve, reject) => {
                    this.SwallowtailArrowClass.showSwallowtailArrow(options).then(entity=>{
            ...
            case "PincerArrow":
                return new Promise((resolve, reject) => {
                    this.PincerArrowClass.showPincerArrow(options).then(entity=>{
            ...
            case "AssemblePolygon":
                return new Promise((resolve, reject) => {
                    this.AssembleClass.showAssemble(options).then(entity=>{
            ...
            case "DefenseLine":
                return new Promise((resolve, reject) => {
                    this.DefenseLineClass.showDefenseLine(options).then(entity=>{
            ...
            case "Polygon":
                return new Promise((resolve, reject) => {
                    this.PolygonClass.showPolygon(options).then(entity=>{
            ...
            case "CurvedPolygon":
                return new Promise((resolve, reject) => {
                    this.CurvePolygonClass.showCurvePolygon(options).then(entity=>{
            ...
            case "Polyline":
                return new Promise((resolve, reject) => {
                    this.PolylineClass.showPolyline(options).then(entity=>{
            ...
            case "Curve":
                return new Promise((resolve, reject) => {
                    this.CurveLineClass.showCurveLine(options).then(entity=>{
            ...
            case "RightAngleArrow":
                return new Promise((resolve, reject) => {
                    this.RightAngleArrowClass.showRightAngleArrow(options).then(entity=>{
            ...
            case "RoundRectangle":
                return new Promise((resolve, reject) => {
                    this.RoundRectangleClass.showRoundRectangle(options).then(entity=>{
            ...
            case "Flag":
                return new Promise((resolve, reject) => {
                    this.FlagClass.showFlag(options).then(entity=>{
            ...
            case "TextBox":
                return new Promise((resolve, reject) => {
                    this.TextBoxClass.showTextBox(options).then(entity=>{
    ...
    CreateAssemble(options) {
        return new Promise((resolve, reject) => {
            this.AssembleClass.createAssemble(
                options,
            ).then(entity => {
                this.situationMap.get("AssemblePolygon").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateAttackArrow(options) {
        return new Promise((resolve, reject) => {
            this.AttackArrowClass.createAttackArrow(
                options,
            ).then(entity => {
                this.situationMap.get("AttackArrow").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreatePolygon(options) {
        return new Promise((resolve, reject) => {
            this.PolygonClass.createPolygon(options).then(entity => {
                this.situationMap.get("Polygon").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
                entity.name = this._getDefaultName(entity.GeoType)
                resolve(entity)
    ...
    CreateCurvedPolygon(options) {
        return new Promise((resolve, reject) => {
            this.CurvePolygonClass.createCurvedPolygon(options).then(entity => {
                this.situationMap.get("CurvedPolygon").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
                entity.name = this._getDefaultName(entity.GeoType)
                resolve(entity)
    ...
    CreateCurve(options) {
        return new Promise((resolve, reject) => {
            this.CurveLineClass.createCurveLine(options).then(entity => {
                this.situationMap.get("Curve").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
                entity.name = this._getDefaultName(entity.GeoType)
                resolve(entity)
    ...
    CreatePolyline(options) {
        return new Promise((resolve, reject) => {
            this.PolylineClass.createPolyline(options).then(entity => {
                this.situationMap.get("Polyline").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
                entity.name = this._getDefaultName(entity.GeoType)
                resolve(entity)
    ...
    CreatePincerArrow(options) {
        return new Promise((resolve, reject) => {
            this.PincerArrowClass.createPincerArrow(
                options
            ).then(entity => {
                this.situationMap.get("PincerArrow").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateRoundRectangle(options) {
        return new Promise((resolve, reject) => {
            this.RoundRectangleClass.createRoundRectangle(
                options,
            ).then(entity => {
                this.situationMap.get("RoundRectangle").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateTextBox(options) {
        return new Promise((resolve, reject) => {
            ...
            this.TextBoxClass.createTextBox(
                options,
            ).then(entity => {
                this.situationMap.get("TextBox").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateRightAngleArrow(options) {
        return new Promise((resolve, reject) => {
            this.RightAngleArrowClass.createRightAngleArrow(
                options,
            ).then(entity => {
                this.situationMap.get("RightAngleArrow").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateLineArrow(options) {
        return new Promise((resolve, reject) => {
            this.LineArrowClass.createLineArrow(
                options
            ).then(entity => {
                this.situationMap.get("LineArrow").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateCurveArrow(options) {
        return new Promise((resolve, reject) => {
            this.CurveArrowClass.createCurveArrow(
                options
            ).then(entity => {
                this.situationMap.get("CurveArrow").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateSwallowtailArrow(options) {
        return new Promise((resolve, reject) => {
            this.SwallowtailArrowClass.createSwallowtailArrow(
                options
            ).then((entity) => {
                this.situationMap.get("SwallowtailArrow").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    CreateDefenseLine(options) {
        return new Promise((resolve, reject) => {
            this.DefenseLineClass.createDefenseLine(
                options
            ).then(entity => {
                this.situationMap.get("DefenseLine").set(entity.id, entity)
                this.viewer.resource.set(entity.id, this.getMilitaryToJson(entity))
    ...
    growArrowTest(id) {
        ...
        const dynamicPositions = new Cesium.CallbackProperty(() => {
            ...
            const currentPoints = arrowPoints.map((point, index) => {
                const startPoint = index > 0 ? arrowPoints[index - 1] : arrowPoints[index];
                return Cesium.Cartesian3.lerp(startPoint, point, t, new Cesium.Cartesian3());
            });
    ...
    getMilitaryToList() {
        const result = []
        const linearAndSurfaceEntities = this.viewer.entities.values.filter(entity => {
            return entity.type === 'situation';
        });
        linearAndSurfaceEntities.forEach(function (entity) {
    ...
    _getDefaultName(geoType) {
        ...
        switch (geoType) {
            case "AttackArrow":
                entityName = "AttackArrow" + ("000" + (Array.from(this.situationMap.get("AttackArrow")).length+1)).substr(-3);
                break
            case "LineArrow":
                entityName = "LineArrow" + ("000" + (Array.from(this.situationMap.get("LineArrow")).length+1)).substr(-3);
                break
            case "CurveArrow":
                entityName = "CurveArrow" + ("000" + (Array.from(this.situationMap.get("CurveArrow")).length+1)).substr(-3);
                break
            case "SwallowtailArrow":
                entityName = "SwallowtailArrow" + ("000" + (Array.from(this.situationMap.get("SwallowtailArrow")).length+1)).substr(-3);
                break
            case "PincerArrow":
                entityName = "PincerArrow" + ("000" + (Array.from(this.situationMap.get("PincerArrow")).length+1)).substr(-3);
                break
            case "AssemblePolygon":
                entityName = "AssemblePolygon" + ("000" + (Array.from(this.situationMap.get("AssemblePolygon")).length+1)).substr(-3);
                break
            case "DefenseLine":
                entityName = "DefenseLine" + ("000" + (Array.from(this.situationMap.get("DefenseLine")).length+1)).substr(-3);
                break
            case "Polygon":
                entityName = "Polygon" + ("000" + (Array.from(this.situationMap.get("Polygon")).length+1)).substr(-3);
                break
            case "CurvedPolygon":
                entityName = "CurvedPolygon" + ("000" + (Array.from(this.situationMap.get("CurvedPolygon")).length+1)).substr(-3);
                break
            case "FreePolygon":
                entityName = "FreePolygon" + ("000" + (Array.from(this.situationMap.get("FreePolygon")).length+1)).substr(-3);
                break
            case "Polyline":
                entityName = "Polyline" + ("000" + (Array.from(this.situationMap.get("Polyline")).length+1)).substr(-3);
                break
            case "Curve":
                entityName = "Curve" + ("000" + (Array.from(this.situationMap.get("Curve")).length+1)).substr(-3);
                break
            case "RightAngleArrow":
                entityName = "RightAngleArrow" + ("000" + (Array.from(this.situationMap.get("RightAngleArrow")).length+1)).substr(-3);
                break
            case "RoundRectangle":
                entityName = "RoundRectangle" + ("000" + (Array.from(this.situationMap.get("RoundRectangle")).length+1)).substr(-3);
                break
            case "RegularPolygon":
                entityName = "RegularPolygon" + ("000" + (Array.from(this.situationMap.get("RegularPolygon")).length+1)).substr(-3);
                break
            case "FreeLine":
                entityName = "FreeLine" + ("000" + (Array.from(this.situationMap.get("FreeLine")).length+1)).substr(-3);
                break
            case "Flag":
                entityName = "Flag" + ("000" + (Array.from(this.situationMap.get("Flag")).length+1)).substr(-3);
                break
            case "TextBox":
                entityName = "TextBox" + ("000" + (Array.from(this.situationMap.get("TextBox")).length+1)).substr(-3);
                break
            default:
                break;
        }
