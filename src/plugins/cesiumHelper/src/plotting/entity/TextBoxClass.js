...
class TextBoxClass {
  ...
  copyTextBoxJson(entity) {
    ...
    textBoxJson.availability =
      dateUtils.parseDateToString(
        "yyyy-MM-ddTHH:mm:ssZ",
        new Date(textBoxJson.startTime)
      ) +
      "/" +
      dateUtils.parseDateToString("yyyy-MM-ddTHH:mm:ssZ", textBoxJson.endTime);
    return textBoxJson;
  }
  ...
  getTextBoxJson(entity) {
    ...
    const temp = {
      ...
      endTime: endTime,
      show:
        entity.label.distanceDisplayCondition?.getValue() instanceof Object
          ? [...Object.values(entity.label.distanceDisplayCondition.getValue())]
          : entity.show,
