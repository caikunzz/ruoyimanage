...
import {
    computeRoundedRectanglePoints, lockingMap,
        ...
        return new Promise((resolve, reject) => {
            ...
            handler.setInputAction(() => {
                ...
                if (options?.show instanceof Array){
                    roundRectangle.polyline.distanceDisplayCondition = new Cesium.DistanceDisplayCondition(...options.show)
                    roundRectangle.polygon.distanceDisplayCondition = new Cesium.DistanceDisplayCondition(...options.show)
                }
    ...
    showRoundRectangle(options) {
        return new Promise((resolve, reject) => {
            ...
            if (existingEntity) {
                ...
                const degreesArrayHeight = computeRoundedRectanglePoints(degreesPositions).map(item=>{
