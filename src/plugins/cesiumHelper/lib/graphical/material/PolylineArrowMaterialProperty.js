...
class PolylineArrowMaterialProperty {
    ...
    getType() {
        return Cesium.Material.PolylineArrowType;
    }
...
Cesium.PolylineArrowMaterialProperty = PolylineArrowMaterialProperty;
Cesium.Material.PolylineArrowType = 'PolylineArrow';
Cesium.Material.PolylineArrowSource = `
#ifdef GL_OES_standard_derivatives
#extension GL_OES_standard_derivatives : enable
#endif
...
Cesium.Material._materialCache.addMaterial(Cesium.Material.PolylineArrowType, {
    fabric: {
        ...
        source: Cesium.Material.PolylineArrowSource
    },
