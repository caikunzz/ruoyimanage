!(function (t, e) {
      ...
      for (
        ...
        for (var m = 0; m < a; m++) {
          ...
          if (null !== (s = h ? c.geometries[m] : c)) {
            ...
            var E = s.type;
            switch (
              ((l = !n || ("Polygon" !== E && "MultiPolygon" !== E) ? 0 : 1), E)
            ) {
              case null:
                break;
              case "Point":
              ...
              case "MultiPoint":
                for (r = 0; r < u.length; r++)
                  e(u[r], p, _, v, x), p++, "MultiPoint" === E && v++;
                "LineString" === E && v++;
                break;
              case "Polygon":
              case "MultiLineString":
  ...
  function V(t, e, n) {
    ...
    if (!t || t.type !== e)
      throw new Error(
        "Invalid input to " + n + ": must be a " + e + ", given " + t.type
      );
  }
  function H(t, e, n) {
        ...
        t.cells.forEach(function (r, i) {
          r.forEach(function (r, o) {
            if (
              ...
              if ("mergeable" === s.info)
                for (
                  var u = s.path[s.path.length - 1][0],
                    c = s.path[s.path.length - 1][1],
                    h = n - 1;
                  h >= 0;
                  h--
                )
                  if (
                    Math.abs(e[h][0][0] - u) <= 1e-7 &&
                    Math.abs(e[h][0][1] - c) <= 1e-7
                  ) {
                    for (var l = s.path.length - 2; l >= 0; --l)
                      e[h].unshift(s.path[l]);
                    a = !0;
                    break;
                  }
              a || (e[n++] = s.path);
              ...
              if (0 !== a && 15 !== a) {
                ...
                (g = d = y = _ = 0.5),
                  1 === a
                    ...
                    ? ((y = $(e, l, u)), (d = $(e, l, h)))
                    : console.log(
                        "MarchingSquaresJS-isoContours: Illegal cval detected: " +
                          a
                      ),
                  (i.cells[o][s] = {
                    cval: a,
  ...
  function ut(t, e, n, r, i) {
    i || (i = yt(null)),
      ...
      (i.maxY = -1 / 0);
    for (var o, s = e; s < n; s++)
      (o = t.children[s]), ct(i, t.leaf ? r(o) : o);
    return i;
  }
  function ct(t, e) {
    return (
  ...
  function xt(t, e, n) {
    ...
    for (
      var r,
        i = (function (t) {
          for (
            var e = t[0], n = t[0], r = t[0], i = t[0], o = 0;
            o < t.length;
            o++
          ) {
            var s = t[o];
          ...
          for (; u; ) {
            ...
            for (; a.length && !a.peek().node.children; ) {
              var p = a.pop(),
                ...
                g = St(f, e, n),
                d = St(f, r, i);
              if (p.dist < g && p.dist < d && bt(n, f, s) && bt(r, f, s))
                return f;
            }
            (u = a.pop()) && (u = u.node);
          }
  ...
  function Pt(t, e, n) {
    ...
    for (var u = 0, c = !1; u < o.length && !c; u++)
      if (Ot(i, o[u][0], r)) {
        for (var h = !1, l = 1; l < o[u].length && !h; )
          Ot(i, o[u][l], !r) && (h = !0), l++;
        h || (c = !0);
      }
    return c;
  ...
  function Tt(t, e) {
    ...
    return c(
      (function (t) {
        ...
        for (; a--; ) {
          for (x.length = 0, p = m.length; p--; )
            (f = t[a].x - m[p].x) > 0 && f * f > m[p].r
              ...
              : ((g = t[a].y - m[p].y),
                f * f + g * g > m[p].r ||
                  (x.push(m[p].a, m[p].b, m[p].b, m[p].c, m[p].c, m[p].a),
                  m.splice(p, 1)));
        ...
        for (; a--; )
          (v[a].a.__sentinel || v[a].b.__sentinel || v[a].c.__sentinel) &&
            v.splice(a, 1);
        return v;
      })(
  ...
  function qt(t, e, n) {
    ...
    var r = n.units,
      ...
      h =
        ...
        Math.pow(Math.sin(a / 2), 2) * Math.cos(u) * Math.cos(c);
    ...
    return t.map(function (t) {
      ...
      for (
        ...
        !(function (t) {
          return !(
            t.length < 3 ||
            (3 === t.length && t[2][0] === t[0][0] && t[2][1] === t[0][1])
          );
        })(i);
      ...
      return (
        (i[i.length - 1][0] === i[0][0] && i[i.length - 1][1] === i[0][1]) ||
          i.push(i[0]),
        i
      );
    });
  ...
  function pe(t, e, n, i) {
    ...
    var o = i.units,
      ...
      l = y(e, o),
      p = Math.asin(
        Math.sin(c) * Math.cos(l) + Math.cos(c) * Math.sin(l) * Math.cos(h)
      );
    return r(
      [
        v(
  ...
  function fe(t, e, n) {
    ...
    for (var s = [], a = 0; a < r; a++)
      s.push(pe(t, e, (-360 * a) / r, n).geometry.coordinates);
  ...
  function ge(t, e, n) {
    ...
    var r = X(t),
      ...
      h =
        Math.cos(a) * Math.sin(u) - Math.sin(a) * Math.cos(u) * Math.cos(s - o);
  ...
  function Ee(t, e) {
    ...
    do {
      if (
        ((n = !1), r.steiner || (!Se(r, r.next) && 0 !== Ce(r.prev, r, r.next)))
      )
        r = r.next;
      else {
        ...
        if (
          ...
          o
            ...
            : (function (t) {
                ...
                for (; i !== t.prev; ) {
                  if (
                    Ne(e.x, e.y, n.x, n.y, r.x, r.y, i.x, i.y) &&
                    Ce(i.prev, i, i.next) >= 0
                  )
                    return !1;
                  i = i.next;
                }
  ...
  function Fe(t, e) {
    ...
    return (
      O(e, function (e, i) {
        var o = qt(t, e);
        o < r &&
          (((n = Gt(e)).properties.featureIndex = i),
  ...
  function je(t, e, n, r, i) {
    i || (i = Ze(null)),
      ...
      (i.maxY = -1 / 0);
    for (var o, s = e; s < n; s++)
      (o = t.children[s]), Xe(i, t.leaf ? r(o) : o);
    return i;
  }
  function Xe(t, e) {
    return (
  ...
  function Ke(t, e, n, r, i) {
    for (var o, s = [e, n]; s.length; )
      (n = s.pop()) - (e = s.pop()) <= r ||
        (qe(t, (o = e + Math.ceil((n - e) / r / 2) * r), e, n, i),
        s.push(e, o, o, n));
  }
  function Qe(t) {
    var e = ke(t);
        ...
        for (var i = U(t), u = 0; u < i.length - 1; u++) {
          ...
          y.features.length > 0 &&
            ...
            h.properties.dist < o.properties.dist &&
              (((o = h).properties.index = u + 1),
              (o.properties.location = s + l)),
            _ &&
              _.properties.dist < o.properties.dist &&
              ((o = _).properties.index = u),
            (s += l);
        }
      }),
      o
  ...
  function an(t, e) {
    ...
    var o = Math.log(
      Math.tan(r / 2 + Math.PI / 4) / Math.tan(n / 2 + Math.PI / 4)
    );
  ...
  function fn(t) {
    ...
    return [
      (t[0] * e) / 6378137,
      (0.5 * Math.PI - 2 * Math.atan(Math.exp(-t[1] / 6378137))) * e,
    ];
  }
  function gn(t, n, i) {
    if (((i = i || {}), !I(i))) throw new Error("options is invalid");
  ...
  function yn(t) {
    for (
      var n = (function (t) {
          if ("FeatureCollection" !== t.type)
            return "Feature" !== t.type ? c([e(t)]) : c([t]);
          return t;
        })(t),
        i = de(n),
        o = !1,
      ...
      if ("Point" === u.type)
        ...
        ("Polygon" !== u.type && "MultiPolygon" !== u.type) ||
          (Pt(i, u) && (o = !0));
      s++;
    }
    if (o) return i;
          ...
          case "Polygon":
            return (function (t, e) {
              ...
              for (var i = !1, o = 0; o < t.coordinates.length - 1; o++) {
                ...
                if (
                  (i || (i = Pt(t.coordinates[o], e, { ignoreBoundary: !0 })),
                  !i)
                ) {
                  var s = (function (t, e) {
      ...
      l = R(
        ...
        function (t, r, i) {
          var o = U(r)[1],
            s = X(e);
          return i === h.id
            ? (t.push(s), n.push(a(t)), qn(s, o) ? [s] : [s, o])
            : (t.push(o), t);
        },
        [r]
      );
  ...
  function Wn(t, e) {
    for (var n = [], r = 0; r < t.length; r++) {
      ...
      i.length > 0 &&
        ((i[0][0] === i[i.length - 1][0] && i[0][1] === i[i.length - 1][1]) ||
          i.push(i[0]),
        i.length >= 4 && n.push(i));
    }
    return n;
      ...
      t === e ||
        (t instanceof Date && e instanceof Date
          ...
          : (function (t, e, n) {
              ...
              if (Jn(t))
                return (
                  !!Jn(e) && ((t = Bs.call(t)), (e = Bs.call(e)), Zn(t, e, n))
                );
              if (Qn(t)) {
                if (!Qn(e)) return !1;
                if (t.length !== e.length) return !1;
          ...
          if (!1 === e) {
            ...
            Zn(i, o)
              ...
              : (
                  0 === r
                    ? Nn(i[0], n) && Nn(i[1], n)
                    : on(n, i[0]).properties.dist <= r &&
                      on(n, i[1]).properties.dist <= r
                )
              ? ((e = !0), (s = s ? tr(s, t) : t))
              : (0 === r
                  ? Nn(o[0], t) && Nn(o[1], t)
                  : on(t, o[0]).properties.dist <= r &&
                    on(t, o[1]).properties.dist <= r) && (s = s ? tr(s, n) : n);
          }
        }),
    ...
    var a = E(e, o, "meters"),
      ...
      c = (function (t, e, n, r) {
        ...
        var h = Math.log(
          ...
          p = (i * Math.sin(a)) / l;
        return [
          (((180 * (o + p)) / Math.PI + 540) % 360) - 180,
          (180 * c) / Math.PI,
        ];
      })(u, a, n);
    return (
      (c[0] += c[0] - u[0] > 180 ? -360 : u[0] - c[0] > 180 ? 360 : 0), r(c, s)
    );
  }
                    ...
                    u = (function (t) {
                      if (t.edges.length > 0) {
                        ...
                        switch (e) {
                          ...
                          default:
                            console.log(
                              "MarchingSquaresJS-isoBands: edge index out of range!"
                            ),
                              console.log(t);
                        }
                      }
                    ...
                    if (
                      ...
                      (c = (function (t, e, n, r) {
                        ...
                        (void 0 !== e &&
                          ...
                          void 0 !== u) ||
                          (console.log(
                            "MarchingSquaresJS-isoBands: undefined value!"
                          ),
                          console.log(t),
                          console.log(
                            e + " " + n + " " + s + " " + a + " " + u
                          ...
                          if (void 0 === t.cells[c] || void 0 === t.cells[c][u])
                            if (
                              ...
                              if (0 === o) {
                                ...
                                if (!(a & js)) {
                                  console.log(
                                    "MarchingSquaresJS-isoBands: wtf"
                                  );
                                  break;
                                }
                                h.push([u, c + 1]), (r = 0), (i = 1), (o = 0);
                              ...
                              if (1 !== r) {
                                console.log(
                                  "MarchingSquaresJS-isoBands: we came from nowhere!"
                                );
                                break;
                              }
                              if (0 === o) {
                            ...
                            ((s = t.cells[c][u]), (a = s.cval_real), -1 === r)
                          )
                            if (0 === o)
                              if (
                                void 0 !== t.cells[c - 1] &&
                                void 0 !== t.cells[c - 1][u]
                              )
                                (r = 0), (i = -1), (o = 1);
                              else {
                                if (!(a & Ys)) {
                              ...
                              console.log(
                                "MarchingSquaresJS-isoBands: proceeding in x-direction!"
                              );
                            }
                          else if (1 === r) {
                            if (0 === o) {
                            ...
                            if (1 !== i) {
                              console.log(
                                "MarchingSquaresJS-isoBands: where did we came from???"
                              );
                              break;
                            }
                            if (0 !== o) {
  ...
  function Cr(t, e) {
    for (
      var n = !1, r = !1, i = t.coordinates.length, o = 0;
      o < i && !n && !r;
      ...
      for (var s = 0; s < e.coordinates.length - 1; s++) {
        ...
        (0 !== s && s !== e.coordinates.length - 2) || (a = !1),
          Lr(e.coordinates[s], e.coordinates[s + 1], t.coordinates[o], a)
            ? (n = !0)
            : (r = !0);
      }
      o++;
  ...
  function Mr(t, e) {
    for (
      var n = !1, i = !1, o = t.coordinates[0].length, s = 0;
      s < o && n && i;
  ...
  function ni(t) {
    var e = t.circle;
    e &&
      (e.P || (iu = e.N), au.remove(e), cu.push(e), Xr(e), (t.circle = null));
  }
  function ri(t) {
    var e =
      hu.pop() ||
  ...
  function oi(t) {
    ...
    for (
      var u = o;
      u.circle &&
      Math.abs(n - u.circle.x) < lu &&
      Math.abs(r - u.circle.cy) < lu;
    ...
    for (
      var c = s;
      c.circle &&
      Math.abs(n - c.circle.x) < lu &&
      Math.abs(r - c.circle.cy) < lu;
    ...
    var h,
      l = a.length;
    for (h = 1; h < l; ++h)
      (c = a[h]), (u = a[h - 1]), Jr(c.edge, u.site, c.site, i);
    (u = a[0]),
      ((c = a[l - 1]).edge = Hr(u.site, c.site, null, i)),
      ei(u),
      ei(c);
  }
  function si(t) {
    ...
    if (
      ...
      !(function (t, e, n, r) {
        for (var i, o = uu.length; o--; )
          (Kr((i = uu[o]), t, e, n, r) &&
            Zr(i, t, e, n, r) &&
            (Math.abs(i[0][0] - i[1][0]) > lu ||
              Math.abs(i[0][1] - i[1][1]) > lu)) ||
            delete uu[o];
      })(s, a, u, c),
        (function (t, e, n, r) {
          var i,
          ...
          for (i = 0; i < y; ++i)
            (o = su[i]) && (o.halfedges.length || delete su[i]);
        })(s, a, u, c);
    }
  ...
  function pi(t, e, n, r) {
    ...
    for (var p = [], f = 0; f < i; f += 1) {
      var g = (-360 * f) / i,
        d =
          (e * n) /
          Math.sqrt(Math.pow(n, 2) + Math.pow(e, 2) * Math.pow(fi(g), 2)),
        y =
          (e * n) /
          Math.sqrt(Math.pow(e, 2) + Math.pow(n, 2) / Math.pow(fi(g), 2));
      if (
        (g < -90 && g >= -270 && (d = -d),
        g < -180 && g >= -360 && (y = -y),
        "degrees" === s)
    ...
    return (
      A(t, function (t, e, n) {
        ...
        if (((r = void 0 === r || null === r ? 1 : r), !b(r)))
          throw new Error(
            "weight value must be a number for feature index " + e
          );
        (r = Number(r)) > 0 &&
          S(t, function (t) {
            (o += t[0] * r), (s += t[1] * r), (a += r);
  ...
  function di(t, e, n, i) {
    ...
    return 1 === c ||
      0 === i ||
      (Math.abs(h - e[0]) < o && Math.abs(l - e[1]) < o)
  ...
  function _i(t) {
    if ((I(t) && (t = t.bbox), t && !Array.isArray(t)))
      throw new Error("bbox is invalid");
    return t
      ? (function (t) {
          return [
            Math.random() * (t[2] - t[0]) + t[0],
            Math.random() * (t[3] - t[1]) + t[1],
          ];
        })(t)
      : [360 * Ei(), 180 * Ei()];
  }
  ...
  function bi(t, e, n) {
    ...
    for (var r = Ni(t, e), i = Object.keys(r), o = 0; o < i.length; o++) {
      for (var s = i[o], a = r[s], u = [], h = 0; h < a.length; h++)
        u.push(t.features[a[h]]);
      n(c(u), s, o);
    }
  }
  function Ii(t, e, n, r) {
      ...
      function c(o, s) {
        ...
        if ((l && p.push([o, s]), v))
          (f = o),
            ...
            (d = a),
            (v = !1),
            a && (E.lineStart(), E.point(o, s));
        else if (a && m) E.point(o, s);
        else {
          var u = [
              (y = Math.max(pg, Math.min(lg, y))),
              (_ = Math.max(pg, Math.min(lg, _))),
            ],
            c = [
              (o = Math.max(pg, Math.min(lg, o))),
              (s = Math.max(pg, Math.min(lg, s))),
            ];
          sg(u, c, t, e, n, r)
  ...
  function bo(t, n, r, i) {
    ...
    if (((g = new Ih().write(g)), !Io(g.coordinates))) {
      var _;
      return (_ = l
        ? { type: g.type, coordinates: Co(g.coordinates, So(s)) }
        : hn(g)).geometry
        ? _
        : e(_, o);
    }
  ...
  function Mo() {
    ...
    return (
      (e = new Ih().write(e)),
      { type: "Feature", geometry: e, properties: arguments[0].properties }
    );
  }
  function Lo(t, n) {
    var r = J(t),
        ...
        for (e.remove({ index: i }, To), r[i] = !0; ; ) {
          ...
          if (s.length > 0) {
            var a = s.map(function (t) {
              return (
                (r[t.index] = !0), e.remove({ index: t.index }, To), t.geojson
              );
            });
    ...
    for (
      ...
      for (var p = 0, f = t[1]; f <= t[3]; ) {
        ...
        h % 2 == 0 && p % 2 == 0
          ...
          i
            ? (Lo(i, g) && s.push(g), Lo(i, d) && s.push(d))
            : (s.push(g), s.push(d)),
          (f += u),
          p++;
      }
  ...
  st.prototype = {
    ...
    remove: function (t, e) {
      if (!t) return this;
      for (
        var n, r, i, o, s = this.data, a = this.toBBox(t), u = [], c = [];
        s || u.length;
    ...
    _build: function (t, e, n, r) {
      ...
      for (_t(t, e, n, p, this.compareMinX), a = e; a <= n; a += p)
        for (
          _t(t, a, (c = Math.min(a + p - 1, n)), l, this.compareMinY), u = a;
          u <= c;
          u += l
        )
          (h = Math.min(u + l - 1, c)),
    ...
    _allDistMargin: function (t, e, n, r) {
      ...
      var i,
        ...
        c = ft(a) + ft(u);
      for (i = e; i < n - e; i++)
        (o = t.children[i]), ct(a, t.leaf ? s(o) : o), (c += ft(a));
      for (i = n - e - 1; i >= e; i--)
        (o = t.children[i]), ct(u, t.leaf ? s(o) : o), (c += ft(u));
      return c;
    },
  ...
  var Ho = function (t, e, n) {
    ...
    Jo = function (t, e) {
      ...
      f < d
        ...
        (c < n && f < d) || h >= r
          ...
          : ((i = g), (h += 1) < r && (d = l((g = e[h]))));
      for (
        var y, _, m = i + o, v = m - i, x = o - v, E = x, w = m;
        c < n && h < r;
    ...
    Ko = function (t, e) {
      ...
      return (
        o[1] && (i[a++] = o[1]), 0 === a && (i[a++] = 0), (i.length = a), i
      );
    },
    Qo = function (t, e) {
      var n = 0 | t.length,
    ...
    $o = mt(function (t) {
      ...
      function o(t) {
        for (
          ...
          0 == (1 & u)
            ? n.push.apply(n, i(e(s, u)))
            : o.push.apply(o, i(e(s, u))),
            a.push("m" + u);
        var c = r(n),
          h = r(o),
    ...
    ts = function (t) {
      ...
      for (r = 2; r < e; ++r) {
        for (
          var a = i[r], u = t[a], c = o.length;
          c > 1 && es(t[o[c - 2]], t[o[c - 1]], u) <= 0;

        )
          (c -= 1), o.pop();
        for (
          o.push(a), c = s.length;
          c > 1 && es(t[s[c - 2]], t[s[c - 1]], u) >= 0;
  ...
  (vt.prototype = {
    ...
    _down: function (t) {
      for (
        var e = this.data, n = this.compare, r = this.length >> 1, i = e[t];
        t < r;
  ...
  var is = function (t, e) {
      for (
        var n = t[0], r = t[1], i = !1, o = 0, s = e.length - 1;
        o < e.length;
        s = o++
      ) {
        var a = e[o][0],
    ...
    cs = function (t) {
      ...
      return function (t, a) {
        ...
        var u = 2,
          c = t.length,
          h = new Array(c);
        for (h[0] = (e += t[0]) * r + o, h[1] = (n += t[1]) * i + s; u < c; )
          (h[u] = t[u]), ++u;
        return h;
      };
    },
    ...
    vs = function (t) {
      ...
      for (i = 0, o = h.length; i < o; ++i) {
        var x = h[i],
          E = x[0] + 1,
          w = x[1];
        for (e(i, l[w - 1], (s = l[E - 1]), (a = l[E])); ++E <= w; )
          e(i, s, (s = a), (a = l[E]));
      }
      p = f = g = null;
      var b,
    ...
    xs = function (t) {
      ...
      for (n = 0, r = s.length; n < r; ++n)
        for (var u = s[n], c = u[0], h = u[1]; ++c < h; )
          i.has(o[c]) &&
            ((e = { 0: c, 1: u[1] }), (u[1] = c), (u = u.next = e));
      for (n = 0, r = a.length; n < r; ++n)
        for (
          var l = a[n], p = l[0], f = p, g = l[1], d = i.has(o[p]);
          ++f < g;
    ...
    (ke.prototype = {
      ...
      remove: function (t, e) {
        ...
        for (
          ...
          if (
            (s ||
              ((s = u.pop()), (r = u[u.length - 1]), (n = c.pop()), (o = !0)),
            s.leaf &&
              -1 !==
                (i = (function (t, e, n) {
                  if (!n) return e.indexOf(t);
      ...
      _build: function (t, e, n, r) {
        ...
        for (Ke(t, e, n, p, this.compareMinX), a = e; a <= n; a += p)
          for (
            Ke(t, a, (c = Math.min(a + p - 1, n)), l, this.compareMinY), u = a;
            u <= c;
            u += l
          )
            (h = Math.min(u + l - 1, c)),
      ...
      _allDistMargin: function (t, e, n, r) {
        ...
        var i,
          ...
          c = He(a) + He(u);
        for (i = e; i < n - e; i++)
          (o = t.children[i]), Xe(a, t.leaf ? s(o) : o), (c += He(a));
        for (i = n - e - 1; i >= e; i--)
        ...
        if (null !== p) {
          ...
          if (
            ...
            var d = p,
              y = !a[d];
            y && (a[d] = !0),
              e ? s.push(e(p, t, n, u, c, f, r, i, h, l, g, y)) : s.push(p);
          }
        }
      }
      function i(t, e) {
    ...
    Ls = function (t) {
      ...
      for (a = 0; a < i; a++) {
        ...
        for (var _ = 0; _ < t.geometry.coordinates[a].length - 1; _++)
          d[a].push([
            new Ps(
              t.geometry.coordinates[a][
                (_ + 1).modulo(t.geometry.coordinates[a].length - 1)
              ],
              1,
              [a, _],
      ...
      for (a = 0; a < d.length; a++)
        for (_ = 0; _ < d[a].length; _++)
          for (var E = 0; E < d[a][_].length; E++) {
            b =
              E == d[a][_].length - 1
                ? d[a][(_ + 1).modulo(t.geometry.coordinates[a].length - 1)][0]
                    .coord
                : d[a][_][E + 1].coord;
            var w = x.search({
              minX: b[0],
      ...
      for (a = 0; a < d.length; a++)
        for (_ = 0; _ < d[a].length; _++)
          for (E = 0; E < d[a][_].length; E++) {
            ...
            I < h
              ? (y[I].nxtIsectAlongRingAndEdge2 =
                  d[a][_][E].nxtIsectAlongEdgeIn)
              : Tn(y[I].ringAndEdge1, d[a][_][E].ringAndEdgeIn)
              ? (y[I].nxtIsectAlongRingAndEdge1 =
                  d[a][_][E].nxtIsectAlongEdgeIn)
              : (y[I].nxtIsectAlongRingAndEdge2 =
                  d[a][_][E].nxtIsectAlongEdgeIn);
          }
      ...
      for (a = 0, _ = 0; _ < i; _++) {
        ...
        for (E = 0; E < y.length; E++)
          if (
            y[E].nxtIsectAlongRingAndEdge1 == C ||
            y[E].nxtIsectAlongRingAndEdge2 == C
          ) {
            var M = E;
            break;
          }
      ...
      for (f = []; N.length > 0; ) {
            ...
            if (
              ...
              Rn(
                [
                  y[F].coord,
                  y[G].coord,
                  y[y[G].nxtIsectAlongRingAndEdge2].coord,
                ],
                1 == T
              )
            ...
            if (
              ...
              Rn(
                [
                  y[F].coord,
                  y[G].coord,
                  y[y[G].nxtIsectAlongRingAndEdge1].coord,
                ],
                1 == T
              )
                ? ((k.parent = R), (k.winding = -T))
        ...
        D.push(y[G].coord),
          f.push(
            o([D], { index: A, parent: R, winding: T, netWinding: void 0 })
          );
      }
      g = c(f);
      return e(), n(), g;
  ...
  var qs = function (t, e, n) {
    ...
    (this.start = new As(t.x, t.y)),
      (this.end = new As(e.x, e.y)),
      (this.properties = n || {});
      ...
      this.outerEdgesSorted ||
        (this.outerEdges.sort(function (e, n) {
          var r = e.to,
            i = n.to;
          if (
            r.coordinates[0] - t.coordinates[0] >= 0 &&
  ...
  (Aa.prototype.getSymetric = function () {
    return (
      this.symetric ||
        ((this.symetric = new Aa(this.to, this.from)),
  ...
  (Da.prototype.push = function (t) {
    ...
    (Da.prototype.isHole = function () {
      var t = this,
        e = this.edges.reduce(function (e, n, r) {
          return (
            n.from.coordinates[1] > t.edges[e].from.coordinates[1] && (e = r), e
          );
        }, 0),
    ...
    (Da.prototype.getEnvelope = function () {
      return this.envelope
        ? this.envelope
        : (this.envelope = he(this.toPolygon()));
    }),
    ...
    (qa.prototype._computeNextCWEdges = function (t) {
      ...
      void 0 === t
        ...
        : t.getOuterEdges().forEach(function (e, n) {
            t.getOuterEdge(
              (0 === n ? t.getOuterEdges().length : n) - 1
            ).symetric.next = e;
          });
    }),
    ...
    za = function (t) {
      (this.precision = t && t.precision ? t.precision : 17),
        ...
        (this.objectComparator =
          t && t.objectComparator ? t.objectComparator : Rr);
    };
  (za.prototype.compare = function (t, e) {
    ...
    (za.prototype.fixStartIndex = function (t, e) {
      ...
      return (
        r >= 0 && (n = [].concat(t.slice(r, t.length), t.slice(1, r + 1))), n
      );
    }),
  ...
  var ja = za,
      ...
      (e.prototype.run = function (t, e, n, r) {
        ...
        (e.prototype._regionQuery = function (t) {
          for (var e = [], n = 0; n < this._datasetLength; n++) {
            this.distance(this.dataset[t], this.dataset[n]) < this.epsilon &&
              e.push(n);
          }
          return e;
        }),
    ...
    Ua = mt(function (t) {
      ...
      (e.prototype.init = function (t, e, n) {
        ...
        (e.prototype.argmin = function (t, e, n) {
          for (
            var r, i = Number.MAX_VALUE, o = 0, s = e.length, a = 0;
            a < s;
            a++
          )
            (r = n(t, e[a])) < i && ((i = r), (o = a));
    ...
    Ha = mt(function (t) {
      t.exports &&
        (t.exports = { DBSCAN: Xa, KMEANS: Ua, OPTICS: Va, PriorityQueue: Ya });
    }),
    Wa =
      (Ha.DBSCAN,
      Ha.KMEANS,
      ...
      do {
        ...
        for (var y = 0; y < h; y++) {
          for (var _ = 1 / 0, m = 0, v = 0; v < e; v++)
            (a = p ? Ka(t[y], i[v]) : Math.abs(t[y] - i[v])) <= _ &&
              ((_ = a), (m = v));
          (s[y] = m), f[m]++;
        }
  ...
  (qr.prototype.init = function () {
    ...
    (qr.prototype.cleanDirty = function () {
      for (var t = 0; t < this.dirtyNodes.length; t++)
        nu.cleanNode(this.dirtyNodes[t]);
      this.dirtyNodes = [];
    }),
    ...
    (qr.prototype.toString = function () {
      for (
        var t, e, n, r, i = [], o = this.grid, s = 0, a = o.length;
        s < a;
        s++
      ) {
    ...
    (Br.prototype = {
      ...
      remove: function (t) {
        ...
        e !== this.content.length - 1 &&
          ((this.content[e] = n),
          this.scoreFunction(n) < this.scoreFunction(t)
            ? this.sinkDown(e)
            : this.bubbleUp(e));
      },
      size: function () {
    ...
    insert: function (t, e) {
      ...
      for (e.L = e.R = null, e.U = n, e.C = !0, t = e; n && n.C; )
        n === (r = n.U).L
          ? (i = r.R) && i.C
            ? ((n.C = i.C = !1), (r.C = !0), (t = r))
            : (t === n.R && (Ur(this, n), (n = (t = n).U)),
              (n.C = !1),
              (r.C = !0),
              Yr(this, r))
          : (i = r.L) && i.C
          ? ((n.C = i.C = !1), (r.C = !0), (t = r))
          : (t === n.L && (Yr(this, n), (n = (t = n).U)),
            (n.C = !1),
            (r.C = !0),
            Ur(this, r)),
          (n = t.U);
        ...
        if (t && t.C) t.C = !1;
          ...
          do {
            ...
            if (t === i.L) {
              if (
                ((e = i.R).C &&
                  ((e.C = !1), (i.C = !0), Ur(this, i), (e = i.R)),
                (e.L && e.L.C) || (e.R && e.R.C))
              ) {
                (e.R && e.R.C) ||
                  ((e.L.C = !1), (e.C = !0), Yr(this, e), (e = i.R)),
                  (e.C = i.C),
                  (i.C = e.R.C = !1),
                  Ur(this, i),
                  (t = this._);
  ...
  hi.prototype = {
    ...
    find: function (t, e, n) {
      for (
        var r, i, o = this, s = o._found || 0, a = o.cells.length;
        !(i = o.cells[s]);
  ...
  var fu = function () {
      function t(t) {
        return new hi(
          t.map(function (r, i) {
            var o = [
              Math.round(e(r, i, t) / lu) * lu,
              Math.round(n(r, i, t) / lu) * lu,
            ];
      ...
      return (
        ...
        (t.x = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : ru(+n)), t)
            : e;
        }),
        (t.y = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : ru(+e)), t)
            : n;
        }),
        (t.extent = function (e) {
          return arguments.length
      ...
      value: function (t) {
        ...
        var i =
          2 in arguments && void 0 !== arguments[2]
            ...
            : n;
        for (
          i = i < 0 ? Math.max(n + arguments[2], 0) : Math.min(i, n);
          r < i;
  ...
  (bu.prototype.setOrdinate = function (t, e) {
    ...
    (bu.prototype.equals2D = function () {
      ...
      if (2 === arguments.length) {
        var e = arguments[0],
          n = arguments[1];
        return (
          !!yu.equalsWithTolerance(this.x, e.x, n) &&
          !!yu.equalsWithTolerance(this.y, e.y, n)
        );
      }
    }),
    ...
    (bu.prototype.hashCode = function () {
      var t = 17;
      return (
        (t = 37 * t + bu.hashCode(this.x)), (t = 37 * t + bu.hashCode(this.y))
      );
    }),
  ...
  var Nu = function (t) {
    if (((this._dimensionsToTest = 2), 0 === arguments.length));
      ...
      var e = arguments[0];
      if (2 !== e && 3 !== e)
        throw new _u("only 2 or 3 dimensions may be specified");
  ...
  (Du.prototype.le = function (t) {
    ...
    (Du.prototype.extractSignificantDigits = function (t, e) {
      ...
      for (
        var o = r + 1, s = new Ru(), a = Du.MAX_PRINT_DIGITS - 1, u = 0;
        u <= a;
        u++
      ) {
        t && u === o && s.append(".");
    ...
    (Du.prototype.pow = function (t) {
      ...
      if (r > 1)
        for (; r > 0; )
          r % 2 == 1 && n.selfMultiply(e), (r /= 2) > 0 && (e = e.sqr());
      else n = e;
  ...
  (qu.prototype.interfaces_ = function () {
    ...
    (qu.intersection = function (t, e, n, r) {
      var i = Du.valueOf(r.y)
          .selfSubtract(n.y)
          .selfMultiply(Du.valueOf(e.x).selfSubtract(t.x)),
        o = Du.valueOf(r.x)
          .selfSubtract(n.x)
          .selfMultiply(Du.valueOf(e.y).selfSubtract(t.y)),
        s = i.subtract(o),
        a = Du.valueOf(r.x)
          .selfSubtract(n.x)
          .selfMultiply(Du.valueOf(t.y).selfSubtract(n.y)),
        u = Du.valueOf(r.y)
          .selfSubtract(n.y)
          .selfMultiply(Du.valueOf(t.x).selfSubtract(n.x)),
  ...
  (Uu.prototype.getY = function () {
    ...
    (Uu.intersection = function (t, e, n, r) {
      var i = t.y - e.y,
        ...
        l = (o * c - u * s) / h,
        p = (a * s - i * c) / h;
      if (mu.isNaN(l) || mu.isInfinite(l) || mu.isNaN(p) || mu.isInfinite(p))
        throw new ju();
      return new bu(l, p);
    });
  var Yu = function t() {
  ...
  var Ju = {
    ...
    Zu = {
      ...
      multipoint: function (t) {
        ...
        for (
          var e, n = t.trim().split(","), r = [], i = 0, o = n.length;
          i < o;
          ++i
        )
          (e = n[i].replace(Hu.trimParens, "$1")),
            r.push(Zu.point.apply(this, [e]));
      ...
      multilinestring: function (t) {
        ...
        for (
          var e, n = t.trim().split(Hu.parenComma), r = [], i = 0, o = n.length;
          i < o;
          ++i
        )
          (e = n[i].replace(Hu.trimParens, "$1")),
            r.push(Zu.linestring.apply(this, [e]));
      ...
      multipolygon: function (t) {
        ...
        for (
          var e,
            n = t.trim().split(Hu.doubleParenComma),
            r = [],
            i = 0,
            o = n.length;
          i < o;
          ...
          (e = n[i].replace(Hu.trimParens, "$1")),
            r.push(Zu.polygon.apply(this, [e]));
  ...
  (tc.prototype.interfaces_ = function () {
    ...
    (tc.equals = function () {
      var t, e, n;
      if (2 === arguments.length)
        (t = arguments[0]), (e = arguments[1]), tc.equals(t, e, null);
      else if (
        3 === arguments.length &&
        ((t = arguments[0]),
        (e = arguments[1]),
  ...
  (ec.prototype.getIndexAlongSegment = function (t, e) {
    ...
    (ec.computeEdgeDistance = function (t, e, n) {
      ...
      return (
        tc.isTrue(!(0 === o && !t.equals(e)), "Bad distance calculation"), o
      );
    }),
    (ec.nonRobustComputeEdgeDistance = function (t, e, n) {
      var r = t.x - e.x,
        ...
        o = Math.sqrt(r * r + i * i);
      return (
        tc.isTrue(!(0 === o && !t.equals(e)), "Invalid distance calculation"), o
      );
    }),
      ...
      return (
        ...
        (e.prototype.intersection = function (t, n, r, i) {
          ...
          return (
            this.isInSegmentEnvelopes(o) ||
              (o = new bu(e.nearestEndpoint(t, n, r, i))),
        ...
        (e.prototype.checkDD = function (t, e, n, r, i) {
          ...
          Xu.out.println("DD in env = " + s + "  --------------------- " + o),
            i.distance(o) > 1e-4 &&
              Xu.out.println("Distance = " + i.distance(o));
        }),
        ...
        (e.prototype.computeIntersect = function (e, n, r, i) {
          if (((this._isProper = !1), !Yu.intersects(e, n, r, i)))
  ...
  (ic.prototype.interfaces_ = function () {
    ...
    (ic.signOfDet2x2 = function (t, e, n, r) {
      ...
      for (;;) {
        if (((s = Math.floor(n / t)), (n -= s * t), (r -= s * e) < 0))
          return -i;
        if (r > e) return i;
        if (t > n + n) {
          if (e < r + r) return i;
  ...
  (oc.prototype.countSegment = function (t, e) {
    ...
    (oc.locatePointInRing = function () {
      ...
      if (arguments[0] instanceof bu && arguments[1] instanceof Array) {
        for (
          var s = arguments[0], a = arguments[1], u = new oc(s), c = 1;
          c < a.length;
          c++
        ) {
          var h = a[c],
    ...
    (sc.distancePointLine = function () {
      if (2 === arguments.length) {
        var t = arguments[0],
          e = arguments[1];
        if (0 === e.length)
          throw new _u("Line array must contain at least one vertex");
  ...
  var bc = (function (t) {
      function e() {
        t.call(this),
          (this.array_ = []),
          arguments[0] instanceof vc && this.addAll(arguments[0]);
      }
      return (
        t && (e.__proto__ = t),
        (e.prototype = Object.create(t && t.prototype)),
    ...
    Nc = (function (t) {
      ...
      return (
        ...
        (e.prototype.addAll = function () {
          if (2 === arguments.length) {
            for (
              var e = arguments[0], n = arguments[1], r = !1, i = e.iterator();
              i.hasNext();
  ...
  (Sc.ForwardComparator.get = function () {
    ...
    (Cc.intersection = function (t, e) {
      for (var n = new Nc(), r = 0; r < t.length; r++)
  ...
  ((Gi.prototype = new Oc()).get = function (t) {
    ...
    (Gi.prototype.values = function () {
      ...
      if (null !== e)
        for (t.add(e.value); null !== (e = Gi.successor(e)); ) t.add(e.value);
      return t;
    }),
      ...
      return (
        ...
        (e.prototype.getCoordinates = function () {
          for (
            ...
            for (
              var r = this._geometries[n].getCoordinates(), i = 0;
              i < r.length;
              i++
            )
              t[++e] = r[i];
        ...
        (e.prototype.equalsExact = function () {
          if (2 === arguments.length) {
            ...
            for (var i = 0; i < this._geometries.length; i++)
              if (!this._geometries[i].equalsExact(r._geometries[i], n))
                return !1;
            return !0;
          }
        ...
        (e.prototype.apply = function () {
          if (Lu(arguments[0], pc))
            ...
            for (
              ...
              (this._geometries[r].apply(n), !n.isDone());
              r++
            );
  ...
  (Uc.prototype.boundaryMultiLineString = function (t) {
    ...
    (Uc.prototype.boundaryLineString = function (t) {
      if (this._geom.isEmpty()) return this.getEmptyMultiPoint();
      if (t.isClosed()) {
        return this._bnRule.isInBoundary(2)
          ? t.getStartPoint()
  ...
  (Vc.prototype.interfaces_ = function () {
    ...
    (Vc.split = function (t, e) {
      for (
        var n = e.length, r = new bc(), i = "" + t, o = i.indexOf(e);
        o >= 0;
  ...
  (Wc.prototype.interfaces_ = function () {
    ...
    (Wc.copyCoord = function (t, e, n, r) {
      for (
        var i = Math.min(t.getDimension(), n.getDimension()), o = 0;
        o < i;
        o++
      )
    ...
    (Wc.isEqual = function (t, e) {
      ...
      for (
        var r = Math.min(t.getDimension(), e.getDimension()), i = 0;
        i < n;
        i++
      )
        for (var o = 0; o < r; o++) {
  ...
  var Jc = (function (t) {
      ...
      return (
        (e.prototype.computeEnvelopeInternal = function () {
          return this.isEmpty()
            ? new Yu()
            : this._points.expandEnvelope(new Yu());
        }),
        ...
        (e.prototype.apply = function () {
          if (Lu(arguments[0], pc))
            ...
            for (
              var r = 0;
              r < this._points.size() &&
              (n.filter(this._points, r), !n.isDone());
              r++
            );
            n.isGeometryChanged() && this.geometryChanged();
          } else if (Lu(arguments[0], kc)) {
      ...
      return (
        ...
        (e.prototype.getArea = function () {
          ...
          for (var e = 0; e < this._holes.length; e++)
            t -= Math.abs(
              sc.signedArea(this._holes[e].getCoordinateSequence())
            );
          return t;
        }),
        ...
        (e.prototype.normalize = function () {
          if (0 === arguments.length) {
            ...
            Cc.scroll(r, i),
              ...
              sc.isCCW(e.getCoordinates()) === n &&
                Cc.reverse(e.getCoordinates());
          }
        }),
        (e.prototype.getCoordinate = function () {
      ...
      return (
        ...
        (e.prototype.getBoundary = function () {
          ...
          for (var t = new bc(), e = 0; e < this._geometries.length; e++)
            for (
              var n = this._geometries[e].getBoundary(), r = 0;
  ...
  (rh.prototype.setCopyUserData = function (t) {
    ...
    (rh.prototype.editGeometryCollection = function (t, e) {
      for (
        var n = e.edit(t, this._factory), r = new bc(), i = 0;
  ...
  var ph = (function (t) {
      ...
      return (
        ...
        (e.prototype.values = function () {
          for (
            var t = new bc(), e = this.map_.values(), n = e.next();
            !n.done;
  ...
  (fh.prototype.equals = function (t) {
    ...
    (fh.prototype.makePrecise = function () {
      if ("number" == typeof arguments[0]) {
        ...
        return this._modelType === fh.FIXED
    ...
    (_h.prototype.createMultiPoint = function () {
      ...
      if (1 === arguments.length) {
        ...
        if (Lu(arguments[0], Bu)) {
          ...
          for (
            var r = new Array(n.size()).fill(null), i = 0;
            i < n.size();
            i++
          ) {
  ...
  var Eh = {
      ...
      MultiPoint: function (t) {
        for (var e = [], n = 0; n < t.length; ++n)
          e.push(Eh.Point.apply(this, [t[n]]));
      ...
      MultiLineString: function (t) {
        for (var e = [], n = 0; n < t.length; ++n)
          e.push(Eh.LineString.apply(this, [t[n]]));
  ...
  (bh.prototype.read = function (t) {
    ...
    return (
      this.precisionModel.getType() === fh.FIXED && this.reducePrecision(e), e
    );
  }),
  ...
  (Ph.prototype.clearVisitedEdges = function () {
    ...
    (Ph.prototype.getEnvelope = function () {
      if (null === this._env) {
        for (var t = new Yu(), e = this._dirEdgeList.iterator(); e.hasNext(); )
          for (
            var n = e.next().getEdge().getCoordinates(), r = 0;
            r < n.length - 1;
            r++
          )
    ...
    (Ph.prototype.copySymDepths = function (t) {
      var e = t.getSym();
      e.setDepth(Nh.LEFT, t.getDepth(Nh.RIGHT)),
        e.setDepth(Nh.RIGHT, t.getDepth(Nh.LEFT));
    }),
  ...
  (Oh.prototype.setAllLocations = function (t) {
    ...
    (Oh.prototype.flip = function () {
      ...
      (this.location[Nh.LEFT] = this.location[Nh.RIGHT]),
        (this.location[Nh.RIGHT] = t);
    }),
    (Oh.prototype.toString = function () {
      var t = new Ru();
      return (
        this.location.length > 1 &&
          t.append(Su.toLocationSymbol(this.location[Nh.LEFT])),
        t.append(Su.toLocationSymbol(this.location[Nh.ON])),
        this.location.length > 1 &&
          t.append(Su.toLocationSymbol(this.location[Nh.RIGHT])),
        t.toString()
      );
    }),
    (Oh.prototype.setLocations = function (t, e, n) {
      (this.location[Nh.ON] = t),
        (this.location[Nh.LEFT] = e),
        (this.location[Nh.RIGHT] = n);
    }),
  ...
  var Rh = function t() {
    if (((this.elt = new Array(2).fill(null)), 1 === arguments.length)) {
      ...
      var r = arguments[0],
        i = arguments[1];
      (this.elt[0] = new Oh(Su.NONE)),
        (this.elt[1] = new Oh(Su.NONE)),
  ...
  (Rh.prototype.getGeometryCount = function () {
    ...
    (Rh.toLineLabel = function (t) {
      for (var e = new Rh(Su.NONE), n = 0; n < 2; n++)
  ...
  (Th.prototype.computeRing = function () {
    ...
    (Th.prototype.mergeLabel = function () {
      if (1 === arguments.length) {
        ...
        if (this._label.getLocation(n) === Su.NONE)
  ...
  (Fh.prototype.setVisited = function (t) {
    ...
    (Fh.prototype.updateIM = function (t) {
      tc.isTrue(this._label.getGeometryCount() >= 2, "found partial label"),
        this.computeIM(t);
    }),
        ...
        (e.prototype.mergeLabel = function () {
          if (arguments[0] instanceof e) {
            ...
            for (var n = arguments[0], r = 0; r < 2; r++) {
              ...
              this._label.getLocation(r) === Su.NONE &&
                this._label.setLocation(r, i);
            }
        }),
        (e.prototype.add = function (t) {
  ...
  var jh = (function (t) {
      ...
      return (
        ...
        (e.prototype.computeDirectedLabel = function () {
          (this._label = new Rh(this._edge.getLabel())),
        ...
        (e.prototype.isLineEdge = function () {
          var t = this._label.isLine(0) || this._label.isLine(1),
            e =
              ...
              this._label.allPositionsEqual(0, Su.EXTERIOR),
            n =
              !this._label.isArea(1) ||
              this._label.allPositionsEqual(1, Su.EXTERIOR);
          return t && e && n;
        }),
  ...
  (tl.prototype.expandToQueue = function (t, e) {
    ...
    (tl.prototype.isLeaves = function () {
      return !(
        tl.isComposite(this._boundable1) || tl.isComposite(this._boundable2)
      );
    }),
  ...
  var el = function t() {
      if (
        ...
        var n = arguments[0];
        tc.isTrue(n > 1, "Node capacity must be greater than 1"),
  ...
  (el.prototype.getNodeCapacity = function () {
    ...
    (el.prototype.itemsTree = function () {
      ...
      if (1 === arguments.length) {
        for (
          var e = arguments[0],
            n = new bc(),
            r = e.getChildBoundables().iterator();
          r.hasNext();
          ...
          if (i instanceof Kh) {
            ...
            i instanceof Hh ? n.add(i.getItem()) : tc.shouldNeverReachHere();
        }
    ...
    (el.prototype.remove = function () {
      ...
      if (3 === arguments.length) {
        ...
        if (o) return !0;
        for (
          var s = null, a = r.getChildBoundables().iterator();
          a.hasNext();
  ...
  var ol = (function (t) {
      ...
      return (
        (e.prototype.createParentBoundablesFromVerticalSlices = function (
          t,
          e
        ) {
  ...
  (cl.prototype.getSplitCoordinates = function () {
    ...
    (cl.prototype.findCollapseIndex = function (t, e, n) {
      ...
      return (
        e.isInterior() || r--, 1 === r && ((n[0] = t.segmentIndex + 1), !0)
      );
    }),
    (cl.prototype.findCollapsesFromInsertedNodes = function (t) {
      for (
        var e = new Array(1).fill(null), n = this.iterator(), r = n.next();
        n.hasNext();
    ...
    (cl.prototype.checkSplitEdgesCorrectness = function (t) {
      ...
      if (!i.equals2D(e[e.length - 1]))
        throw new Qu("bad split edge end point at " + i);
    }),
  ...
  (fl.prototype.getCoordinates = function () {
    ...
    (fl.getNodedSubstrings = function () {
      ...
      if (2 === arguments.length)
        for (
          var n = arguments[0], r = arguments[1], i = n.iterator();
          i.hasNext();
  ...
  (gl.prototype.minX = function () {
    ...
    (gl.prototype.closestPoints = function (t) {
      ...
      return (
        (i = u.distance(this.p1)) < r &&
          ((r = i), (n[0] = this.p1), (n[1] = u)),
        n
      );
    }),
  ...
  var El = (function (t) {
      ...
      return (
        ...
        (e.prototype.add = function (t) {
          for (
            var e = ml.getChains(t.getCoordinates(), t).iterator();
            e.hasNext();
        ...
        (e.prototype.intersectChains = function () {
          for (
            var t = new wl(this._segInt), e = this._monoChains.iterator();
            e.hasNext();

          )
            for (
              var n = e.next(),
                r = this._index.query(n.getEnvelope()).iterator();
              r.hasNext();
              ...
              if (
                (i.getId() > n.getId() &&
                  (n.computeOverlaps(i, t), this._nOverlaps++),
                this._segInt.isDone())
              )
                return null;
            }
  ...
  (Nl.prototype.isDeletable = function (t, e, n, r) {
    ...
    (Nl.prototype.isShallowConcavity = function (t, e, n, r) {
      if (!(sc.computeOrientation(t, e, n) === this._angleOrientation))
        return !1;
    ...
    (Nl.prototype.findNextNonDeletedIndex = function (t) {
      for (
        var e = t + 1;
        e < this._inputLine.length && this._isDeleted[e] === Nl.DELETE;
    ...
    (Ol.prototype.init = function (t) {
      (this._distance = t),
        ...
        this._segList.setMinimumVertexDistance(
          t * Ol.CURVE_VERTEX_SNAP_DISTANCE_FACTOR
        );
    }),
  ...
  (Al.prototype.findStabbedSegments = function () {
    if (1 === arguments.length) {
      for (
        var t = arguments[0], e = new bc(), n = this._subgraphs.iterator();
        n.hasNext();
  ...
  (ql.prototype.area = function () {
    ...
    (ql.isAcute = function (t, e, n) {
      return (
        !!Ll.isAcute(t, e, n) && !!Ll.isAcute(e, n, t) && !!Ll.isAcute(n, t, e)
      );
    }),
  ...
  (Gl.prototype.addPoint = function (t) {
    ...
    (Gl.prototype.addPolygonRing = function (t, e, n, r, i) {
      ...
      var o = r,
        s = i;
      t.length >= eh.MINIMUM_VALID_SIZE &&
        sc.isCCW(t) &&
        ((o = i), (s = r), (n = Nh.opposite(n)));
  ...
  (kl.prototype.next = function () {
    if (this._atStart)
      return (
        (this._atStart = !1),
        kl.isAtomic(this._parent) && this._index++,
        this._parent
      );
    ...
    return t instanceof jc
      ? ((this._subcollectionIterator = new kl(t)),
  ...
  (zl.prototype.locate = function (t) {
    ...
    (zl.isPointInRing = function (t, e) {
      return (
        ...
        sc.isPointInRing(t, e.getCoordinates())
      );
    }),
  ...
  (jl.prototype.getNextCW = function (t) {
    ...
    (jl.prototype.propagateSideLabels = function (t) {
      for (var e = Su.NONE, n = this.iterator(); n.hasNext(); ) {
        ...
        r.isArea(t) &&
          r.getLocation(t, Nh.LEFT) !== Su.NONE &&
          (e = r.getLocation(t, Nh.LEFT));
      }
      ...
      for (var i = e, o = this.iterator(); o.hasNext(); ) {
        var s = o.next(),
          a = s.getLabel();
        if (
          (a.getLocation(t, Nh.ON) === Su.NONE && a.setLocation(t, Nh.ON, i),
          a.isArea(t))
        ) {
          ...
          if (c !== Su.NONE) {
            if (c !== i)
              throw new Mh("side location conflict", s.getCoordinate());
            u === Su.NONE &&
              tc.shouldNeverReachHere(
            ...
            tc.isTrue(
              a.getLocation(t, Nh.LEFT) === Su.NONE,
    ...
    (jl.prototype.getEdges = function () {
      return (
        null === this._edgeList &&
          (this._edgeList = new bc(this._edgeMap.values())),
        this._edgeList
      );
    }),
      ...
      return (
        ...
        (e.prototype.linkResultDirectedEdges = function () {
          ...
          if (n === this._LINKING_TO_OUTGOING) {
            if (null === t)
              throw new Mh("no outgoing dirEdge found", this.getCoordinate());
            tc.isTrue(t.isInResult(), "unable to link last incoming dirEdge"),
              e.setNext(t);
          }
        }),
        ...
        (e.prototype.computeDepths = function () {
          if (1 === arguments.length) {
            ...
            for (
              var o = arguments[0], s = arguments[1], a = arguments[2], u = o;
              u < s;
              u++
            ) {
        ...
        (e.prototype.getOutgoingDegree = function () {
          ...
          if (1 === arguments.length) {
            for (
              var n = arguments[0], r = 0, i = this.iterator();
              i.hasNext();
        ...
        (e.prototype.findCoveredLineEdges = function () {
          ...
          for (var i = t, o = this.iterator(); o.hasNext(); ) {
            ...
            s.isLineEdge()
              ...
              : (s.isInResult() && (i = Su.EXTERIOR),
                a.isInResult() && (i = Su.INTERIOR));
          }
        }),
        (e.prototype.computeLabelling = function (e) {
          ...
          for (var n = this.iterator(); n.hasNext(); )
            for (var r = n.next().getEdge().getLabel(), i = 0; i < 2; i++) {
              ...
              (o !== Su.INTERIOR && o !== Su.BOUNDARY) ||
                this._label.setLocation(i, Su.INTERIOR);
            }
        }),
        (e.prototype.interfaces_ = function () {
          return [];
    ...
    (Ql.prototype.computeIntersectsForChain = function () {
      if (4 === arguments.length) {
        ...
        var i = arguments[0],
          ...
          f = s.pts[u];
        if (o - i == 1 && u - a == 1)
          return c.addIntersections(this.e, i, s.e, a), null;
        if (
          (this.env1.init(h, l),
          this.env2.init(p, f),
  ...
  var ep = (function (t) {
      ...
      return (
        ...
        (e.prototype.equals = function (t) {
          ...
          for (
            var r = !0, i = !0, o = this.pts.length, s = 0;
            s < this.pts.length;
            s++
          )
            if (
        ...
        (e.updateIM = function () {
          ...
          var e = arguments[0],
            n = arguments[1];
          n.setAtLeastIfValid(
            e.getLocation(0, Nh.ON),
            e.getLocation(1, Nh.ON),
            1
          ),
            e.isArea() &&
              (n.setAtLeastIfValid(
                e.getLocation(0, Nh.LEFT),
                e.getLocation(1, Nh.LEFT),
                2
              ),
              n.setAtLeastIfValid(
                e.getLocation(0, Nh.RIGHT),
                e.getLocation(1, Nh.RIGHT),
                2
              ));
        }),
        e
  ...
  (np.prototype.setWorkingPrecisionModel = function (t) {
    ...
    (np.prototype.insertUniqueEdge = function (t) {
      ...
      if (null !== e) {
        ...
        this._edgeList.add(t), t.setDepthDelta(np.depthDelta(t.getLabel()));
    }),
  ...
  (rp.prototype.rescale = function () {
    ...
    (rp.prototype.scale = function () {
      if (Lu(arguments[0], vc)) {
        for (
          var t = arguments[0], e = new bc(), n = t.iterator();
          n.hasNext();
      ...
      if (arguments[0] instanceof Array) {
        for (
          var i = arguments[0], o = new Array(i.length).fill(null), s = 0;
          s < i.length;
          s++
        )
          o[s] = new bu(
  ...
  (ip.prototype.checkEndPtVertexIntersections = function () {
    if (0 === arguments.length)
      ...
      for (var n = arguments[0], r = arguments[1].iterator(); r.hasNext(); )
        for (var i = r.next().getCoordinates(), o = 1; o < i.length - 1; o++)
          if (i[o].equals(n))
            throw new Qu(
              "found endpt/interior pt intersection at index " + o + " :pt " + n
            );
  }),
    ...
    (ip.prototype.checkCollapses = function () {
      if (0 === arguments.length)
        ...
        for (
          var n = arguments[0].getCoordinates(), r = 0;
          r < n.length - 2;
          r++
        )
    ...
    (ip.prototype.checkCollapse = function (t, e, n) {
      if (t.equals(n))
        throw new Qu(
          "found non-noded collapse at " + ip.fact.createLineString([t, e, n])
        );
    }),
  ...
  (fp.prototype.checkCorrectness = function (t) {
    ...
    (fp.prototype.computeVertexSnaps = function () {
      if (Lu(arguments[0], vc))
        ...
        for (
          var n = arguments[0], r = n.getCoordinates(), i = 0;
          i < r.length;
          i++
        ) {
  ...
  var yp = function () {
    (this._pt = [new bu(), new bu()]),
      (this._distance = mu.NaN),
      (this._isNull = !0);
  };
  ...
  var xp = function (t) {
    (this._maxPtDist = new yp()),
      (this._minPtDist = new yp()),
      (this._geom = t || null);
  };
    ...
    (wp.getPolygons = function () {
      ...
      if (2 === arguments.length) {
        var e = arguments[0],
          n = arguments[1];
        return (
          e instanceof $c ? n.add(e) : e instanceof jc && e.apply(new wp(n)), n
        );
      }
    });
  var bp = function () {
    ...
    (bp.getLines = function () {
      ...
      if (2 === arguments.length) {
        if (Lu(arguments[0], vc) && Lu(arguments[1], vc)) {
          for (
            var e = arguments[0], n = arguments[1], r = e.iterator();
            r.hasNext();
  ...
  (Ip.prototype.locateInternal = function () {
    ...
    (Ip.prototype.computeLocation = function (t, e) {
      if (
        (e instanceof Kc && this.updateLocationInfo(this.locateInternal(t, e)),
        e instanceof Jc)
      )
    ...
    (Sp.getPoints = function () {
      if (1 === arguments.length) {
        ...
        return t instanceof Kc
          ? $h.singletonList(t)
          : Sp.getPoints(t, new bc());
      }
      if (2 === arguments.length) {
        var e = arguments[0],
          n = arguments[1];
        return (
          e instanceof Kc ? n.add(e) : e instanceof jc && e.apply(new Sp(n)), n
        );
      }
    });
  var Mp = function () {
  ...
  (Lp.prototype.computeContainmentDistance = function () {
    if (0 === arguments.length) {
      ...
      if (i.size() > 0) {
        ...
        if (
          (this.computeContainmentDistance(o, i, n),
          this._minDistance <= this._terminateDistance)
        )
          return (
      ...
      if (
        ...
        if (Su.EXTERIOR !== this._ptLocator.locate(d, f))
          return (
            (this._minDistance = 0), (g[0] = p), (g[1] = new Np(f, d)), null
          );
      }
  }),
      ...
      if (0 === arguments.length) {
        ...
        if (
          ...
          if (
            ...
            return null;
          for (
            var r = t.getCoordinates(), i = e.getCoordinate(), o = 0;
            o < r.length - 1;
            o++
          ) {
  ...
  (Fp.prototype.checkMaximumDistance = function (t, e, n) {
    ...
    (Fp.prototype.checkNegativeValid = function () {
      if (
        !(
          this._input instanceof $c ||
          this._input instanceof nh ||
          this._input instanceof jc
        )
      )
        return null;
    ...
    (Fp.prototype.checkMinimumDistance = function (t, e, n) {
      var r = new Lp(t, e, n);
      if (
        ((this._minDistanceFound = r.distance()), this._minDistanceFound < n)
      ) {
        this._isValid = !1;
    ...
    (Fp.prototype.getPolygonLines = function (t) {
      for (
        var e = new bc(), n = new bp(e), r = wp.getPolygons(t).iterator();
        r.hasNext();
  ...
  (Gp.prototype.isValid = function () {
    ...
    (Gp.prototype.checkPolygonal = function () {
      this._result instanceof $c ||
        this._result instanceof nh ||
        (this._isValid = !1),
  ...
  (Hp.prototype.transformPoint = function (t, e) {
    ...
    (Hp.prototype.transformPolygon = function (t, e) {
      ...
      var a = new bc();
      return (
        null !== r && a.add(r), a.addAll(i), this._factory.buildGeometry(a)
      );
    }),
  ...
  (Wp.prototype.snapVertices = function (t, e) {
    for (var n = this._isClosed ? t.size() - 1 : t.size(), r = 0; r < n; r++) {
      ...
      null !== o &&
        (t.set(r, new bu(o)),
        0 === r && this._isClosed && t.set(t.size() - 1, new bu(o)));
    }
  }),
  ...
  (Jp.prototype.snapTo = function (t, e) {
    ...
    (Jp.prototype.extractTargetCoordinates = function (t) {
      for (var e = new ki(), n = t.getCoordinates(), r = 0; r < n.length; r++)
        e.add(n[r]);
    ...
    (Jp.computeOverlaySnapTolerance = function () {
      ...
      if (2 === arguments.length) {
        var i = arguments[0],
          o = arguments[1];
        return Math.min(
          Jp.computeOverlaySnapTolerance(i),
          Jp.computeOverlaySnapTolerance(o)
        );
      }
    }),
  ...
  (Qp.prototype.getCommon = function () {
    ...
    (Qp.prototype.add = function (t) {
      ...
      if (Qp.signExpBits(e) !== this._commonSignExp)
        return (this._commonBits = 0), null;
      (this._commonMantissaBitsCount = Qp.numCommonMostSigMantissaBits(
        this._commonBits,
        e
      )),
  ...
  (rf.prototype.selfSnap = function (t) {
    ...
    (rf.prototype.computeSnapTolerance = function () {
      this._snapTolerance = Jp.computeOverlaySnapTolerance(
        this._geom[0],
        this._geom[1]
      );
    }),
        ...
        (e.prototype.processOverlaps = function (t, e, n, r) {
          for (var i = n.getObject(), o = t; o < e; o++) {
            ...
            if (s.isInsert()) {
              var a = s.getObject();
              n.isSameLabel(s) ||
                (i.computeIntersections(a, r), this.nOverlaps++);
            }
          }
        }),
  ...
  (_f.prototype.buildTree = function () {
    ...
    (_f.prototype.insert = function (t, e, n) {
      if (null !== this._root)
        throw new Error(
          "AttackArrowClass cannot be added to once it has been queried"
        );
    ...
    (_f.prototype.printNode = function (t) {
      Xu.out.println(
        Ku.toLineString(
          new bu(t._min, this._level),
          new bu(t._max, this._level)
        )
      );
    }),
  ...
  var bf = (function (t) {
      ...
      return (
        ...
        (e.prototype.addPolygonRing = function (t, e, n) {
          ...
          if (r.length < 4)
            return (
              (this._hasTooFewPoints = !0), (this._invalidPoint = r[0]), null
            );
          var i = e,
            o = n;
          sc.isCCW(r) && ((i = n), (o = e));
        ...
        (e.prototype.add = function () {
          ...
          if (e.isEmpty()) return null;
          if (
            (e instanceof nh && (this._useBoundaryDeterminationRule = !1),
            e instanceof $c)
          )
            this.addPolygon(e);
        ...
        (e.prototype.locate = function (t) {
          return Lu(this._parentGeom, Qc) &&
            this._parentGeom.getNumGeometries() > 50
            ? (null === this._areaPtLocator &&
                (this._areaPtLocator = new vf(this._parentGeom)),
      ...
      (e.prototype.findResultAreaEdges = function (t) {
        for (var n = this._graph.getEdgeEnds().iterator(); n.hasNext(); ) {
          ...
          i.isArea() &&
            ...
            e.isResultOfOp(
              i.getLocation(0, Nh.RIGHT),
              i.getLocation(1, Nh.RIGHT),
              t
            ) &&
            r.setInResult(!0);
        }
    ...
    (Cf.isResultOfOp = function () {
      ...
      if (3 === arguments.length) {
        var i = arguments[0],
          ...
          s = arguments[2];
        switch (
          (i === Su.BOUNDARY && (i = Su.INTERIOR),
          o === Su.BOUNDARY && (o = Su.INTERIOR),
          s)
        ) {
          case Cf.INTERSECTION:
  ...
  (Lf.prototype.extractPoints = function (t, e, n) {
    ...
    (Lf.prototype.getPoints = function (t) {
      for (
        var e = new bc(), n = bp.getLines(this._g).iterator();
        n.hasNext();
  ...
  (Pf.prototype.reportResult = function (t, e, n) {
    ...
    (Pf.prototype.checkValid = function () {
      ...
      if (2 === arguments.length) {
        ...
        return (
          ...
          !!Pf.hasLocation(this._location, Su.BOUNDARY) ||
    ...
    (Pf.computeBoundaryDistanceTolerance = function (t, e) {
      return Math.min(
        Jp.computeSizeBasedSnapTolerance(t),
        Jp.computeSizeBasedSnapTolerance(e)
      );
    }),
  ...
  var Tf = function () {
      ...
      var t = arguments[0];
      (this._inputPolys = t),
        null === this._inputPolys && (this._inputPolys = new bc());
    },
  ...
  (Tf.prototype.reduceToGeometries = function (t) {
    for (var e = new bc(), n = t.iterator(); n.hasNext(); ) {
      var r = n.next(),
        i = null;
      Lu(r, wc) ? (i = this.unionTree(r)) : r instanceof cc && (i = r),
        e.add(i);
    }
    return e;
  }),
    ...
    (Tf.prototype.union = function () {
      ...
      for (
        var t = new ol(Tf.STRTREE_NODE_CAPACITY),
    ...
    (Tf.prototype.binaryUnion = function () {
      ...
      if (3 === arguments.length) {
        ...
        if (r - n == 2)
          return this.unionSafe(Tf.getGeometry(e, n), Tf.getGeometry(e, n + 1));
    ...
    (Tf.restrictToPolygons = function (t) {
      ...
      return 1 === e.size()
        ? e.get(0)
        : t.getFactory().createMultiPolygon(_h.toPolygonArray(e));
    }),
  ...
  (Df.prototype.interfaces_ = function () {
    ...
    (Df.union = function (t, e) {
      if (t.isEmpty() || e.isEmpty()) {
        if (t.isEmpty() && e.isEmpty())
          return Cf.createEmptyResult(Cf.UNION, t, e, t.getFactory());
        if (t.isEmpty()) return e.copy();
        if (e.isEmpty()) return t.copy();
      }
      return (
  ...
  Yi.prototype = {
    ...
    add: function (t) {
      Vi(qf, t, this.t),
        Vi(this, qf.s, this.s),
        this.s ? (this.t += qf.t) : (this.s = qf.t);
    },
    valueOf: function () {
      return this.s;
    },
  ...
  var ig = function (t) {
      ...
      return (
        ...
        (e.invert = function (e) {
          return (
            (e = t.invert(e[0] * Uf, e[1] * Uf)), (e[0] *= Xf), (e[1] *= Xf), e
          );
        }),
        e
      );
    ...
    ug = function (t, e, n, r, i) {
      ...
      if (
        ...
        for (u.sort(e), po(a), po(u), o = 0, s = u.length; o < s; ++o)
          u[o].e = n = !n;
        for (var c, h, l = a[0]; ; ) {
          ...
          function p() {
            ...
            if ((d.pop(), f.push(d), (d = null), a))
              if (1 & i) {
                ...
                a > 1 && 2 & i && s.push(s.pop().concat(s.shift())),
                  g.push(s.filter(go));
          }
          var f,
            g,
      ...
      return +e
        ? (function (t, e) {
            ...
            return function (e) {
              ...
              function c() {
                n(_, m, y, v, x, E, l, p, h, f, g, d, bg, e),
                  (w.lineEnd = s),
                  s();
              }
              var h,
  ...
  (t.projection = Cs),
    ...
    (t.isolines = function (t, e, n) {
      ...
      if ((W(t, "Point", "Input must contain Points"), !e))
    ...
    (t.concave = function (t, n) {
      ...
      var o = $t(i, n);
      return (
        1 === o.coordinates.length &&
          ((o.coordinates = o.coordinates[0]), (o.type = "Polygon")),
        e(o)
      );
    }),
      ...
      return (
        ...
        t.features.forEach(function (t) {
          ...
          var e = j(t),
            n = [];
          i
            .search({ minX: e[0], minY: e[1], maxX: e[2], maxY: e[3] })
            .forEach(function (e) {
    ...
    (t.tesselate = function (t) {
      if (
        !t.geometry ||
        ("Polygon" !== t.geometry.type && "MultiPolygon" !== t.geometry.type)
      )
          ...
          switch (t.geometry ? t.geometry.type : t.type) {
            case "GeometryCollection":
              return (
                A(t, function (t) {
                  "Point" === t.type &&
                    e.push({ type: "Feature", properties: {}, geometry: t });
                }),
    ...
    (t.planepoint = function (t, e) {
      ...
      if (r.length < 4)
        throw new Error(
          "OuterRing of a Polygon must have 4 or more Positions."
        );
      var i = e.properties || {},
        o = i.a,
        s = i.b,
    ...
    (t.lineSlice = function (t, e, n) {
      ...
      for (
        var i,
          ...
          s = on(n, e),
          u = [
            (i = o.properties.index <= s.properties.index ? [o, s] : [s, o])[0]
    ...
    (t.greatCircle = function (t, e, n) {
      ...
      return (
        ...
        (i = i || 100),
        (o = o || 10),
        new qs({ x: t[0], y: t[1] }, { x: e[0], y: e[1] }, r)
          .Arc(i, { offset: o })
          .json()
      );
    }),
                ...
                for (
                  ...
                  for (var r = 0; r < e.length; r++)
                    if (!e[r].grouped) {
                      ...
                      for (
                        var s = o([e[r].lrCoordinates]), a = r + 1;
                        a < e.length;
                        a++
                      )
                        if (!e[a].grouped) {
                          ...
                          (function (t, e) {
                            ...
                            (i.push(e[a].lrCoordinates), (e[a].grouped = !0));
                        }
                      n.push(i);
                    }
                return n;
          ...
          switch (r) {
            ...
            case "MultiPoint":
              return (function (t, e) {
                for (var n = !1, r = 0; r < e.coordinates.length; r++)
                  if (
                    (Nn(e.coordinates[r], t, { ignoreEndVertices: !0 }) &&
                      (n = !0),
        ...
        case "Polygon":
          switch (r) {
            ...
            case "MultiPoint":
              return (function (t, e) {
                for (var n = 0; n < e.coordinates.length; n++)
                  if (!Pt(e.coordinates[n], t, { ignoreBoundary: !0 }))
                    return !1;
                return !0;
              })(i, o);
            default:
    ...
    (t.clustersDbscan = function (t, e, n) {
      ...
      var r = n.minPoints,
        i = n.units;
      if (
        (W(t, "Point", "Input must contain Points"), null === e || void 0 === e)
      )
      ...
      return (
        ...
        o.noise.forEach(function (e) {
          var n = t.features[e];
          n.properties || (n.properties = {}),
            n.properties.cluster
              ? (n.properties.dbscan = "edge")
              : (n.properties.dbscan = "noise");
        }),
        t
      );
    }),
    ...
    (t.booleanParallel = function (t, e) {
      ...
      if ("LineString" !== Dr(t, "line1"))
        throw new Error("line1 must be a LineString");
      if ("LineString" !== Dr(e, "line2"))
        throw new Error("line2 must be a LineString");
      for (
        var n = en(te(t)).features, r = en(te(e)).features, i = 0;
        i < n.length;
        i++
      ) {
                ...
                ((void 0 !== n && l.properties[n] !== c.properties[n]) ||
                  (Tr(c, l) &&
                    ...
                    s.remove(c, function (t, e) {
                      return (
                        t.properties.origIndexPosition ===
                        e.properties.origIndexPosition
                      );
                    }),
                    (h = !0))));
            }
