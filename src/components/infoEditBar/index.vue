<template>
  <div class="entityEditContainer" v-if="open">
    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item
        title="基本信息"
        v-if="editSupport.info.indexOf(form.type) !== -1"
        name="info"
      >
      ...
      <el-collapse-item
        title="文字"
        v-if="
          editSupport.text.indexOf(form.type) !== -1 ||
          editSupport.text.indexOf(form.geoType) !== -1
        "
        name="text"
      >
      ...
      <el-collapse-item
        title="变换"
        v-if="
          editSupport.transform.indexOf(form.type) !== -1 ||
          editSupport.transform.indexOf(form.geoType) !== -1
        "
        name="transform"
      >
      ...
      <el-collapse-item
        title="过渡"
        v-if="editSupport.transition.indexOf(form.type) !== -1"
        name="transition"
      >
      ...
      <el-collapse-item
        title="材质"
        v-if="
          editSupport.material.indexOf(form.type) !== -1 &&
          form.geoType !== 'TextBox'
        "
        name="material"
      >
      ...
      <el-collapse-item
        title="可见性"
        v-if="editSupport.visibility.indexOf(form.type) !== -1"
        name="visibility"
      >
      ...
      <el-collapse-item
        title="运动路线"
        v-if="
          editSupport.run.indexOf(form.type) !== -1 ||
          editSupport.run.indexOf(form.geoType) !== -1
        "
        name="run"
      >
      ...
      <el-collapse-item
        title="动画"
        v-if="editSupport.animation.indexOf(form.type) !== -1"
        name="animation"
      >
      ...
      <el-collapse-item
        title="时间线"
        v-if="editSupport.times.indexOf(form.type) !== -1"
        name="times"
      >
      ...
      <el-collapse-item
        title="数据交互"
        v-if="editSupport.dbInteractive.indexOf(form.type) !== -1"
        name="dbInteractive"
      >
      ...
      <el-collapse-item
        title="快速操作"
        v-if="editSupport.quick.indexOf(form.type) !== -1"
        name="quick"
      >
