...
<template>
  ...
  >
    <el-form-item
      label="类型："
      v-if="
        supports.type.indexOf('**') !== -1 ||
        supports.type.indexOf(form.type) !== -1 ||
        supports.type.indexOf(form.geoType) !== -1
      "
    >
      <el-select
        disabled
    ...
    <el-form-item
      label="名称："
      v-if="
        supports.name.indexOf('**') !== -1 ||
        supports.name.indexOf(form.type) !== -1 ||
        supports.name.indexOf(form.geoType) !== -1
      "
    >
      <el-input
        v-model="form.name"
    ...
    <el-form-item
      v-if="
        supports.came.indexOf('**') !== -1 ||
        supports.came.indexOf(form.type) !== -1 ||
        supports.came.indexOf(form.geoType) !== -1
      "
      label="阵营："
    >
      <el-select
